...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const view_payment_wrkr(title: 'Payment History'),
    );
  }
}

class view_payment_wrkr extends StatefulWidget {
  const view_payment_wrkr({super.key, required this.title});

  final String title;

  @override
  State<view_payment_wrkr> createState() => _view_payment_wrkrState();
}

class _view_payment_wrkrState extends State<view_payment_wrkr> {

  _view_payment_wrkrState() {
    view_notification();
  }
  ...
  Future<void> view_notification() async {
    ...
    try {
      ...
      String url = '$urls/view_payment_wrkr/';
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 8),
                    Text("Payment: ${payment_[index]}", style: TextStyle(fontWeight: FontWeight.bold)),
                    SizedBox(height: 8),
