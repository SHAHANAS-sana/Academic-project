...
import 'package:roadmate/user_home/core/app_asset.dart';
import 'package:roadmate/user_home/src/model/furniture.dart';
import 'package:roadmate/user_home/src/model/furniture_color.dart';
import 'package:roadmate/user_home/src/model/bottom_navigation_item.dart';
...
class AppData {
  ...
  static List<BottomNavigationItem> bottomNavigationItems = [
    ...
    const BottomNavigationItem(Icon(Icons.password), 'Password'),
    const BottomNavigationItem(Icon(Icons.rate_review), 'Rating'),
