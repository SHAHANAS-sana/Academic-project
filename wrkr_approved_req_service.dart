...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const wrkr_view_approved_req(title: 'Approved Service Requests'),
    );
  }
}

class wrkr_view_approved_req extends StatefulWidget {
  const wrkr_view_approved_req({super.key, required this.title});

  final String title;

  @override
  State<wrkr_view_approved_req> createState() => _wrkr_view_approved_reqState();
}

class _wrkr_view_approved_reqState extends State<wrkr_view_approved_req> {
  _wrkr_view_approved_reqState() {
    view_notification();
  }
  ...
  Future<void> view_notification() async {
    ...
    try {
      ...
      String url = '$urls/wrkr_view_approved_req/';
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        // ElevatedButton(
                        //   onPressed: () async {
                        //     // Implement the approve button functionality here
                        ...
                        // ElevatedButton(
                        //   onPressed: () async {
                        //     // Implement the reject button functionality here
